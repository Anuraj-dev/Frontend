...
## 🚧 In progress / next
- **PR open:** Cloudinary media pipeline + migrate site images off git — **merge when CI is green** (`feat/cloudinary-media-pipeline`). After merge: hard-refresh Teams/Events and confirm images load from `res.cloudinary.com`.
